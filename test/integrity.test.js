...
describe('integrity', function () {
  it('should make sure api-sim supplies all the functions in api', function () {
    ...
    const notApi = '_stats, version, g, root, omitTraceId, logger, loggers, probes, specialUrls, execEnv, cfg, getDomainPrefix, makeLogMissing, modeMap, modeToStringMap, cls, addon, reporter, control, startup, debugLogging, traceMode, sampleRate, tracing, traceId, lastEvent, lastSpan, maps, requestStore, resetRequestStore, clsCheck, stack, backtrace, bind, bindEmitter, setCustomTxNameFunction, wrappedFlag, fs'
